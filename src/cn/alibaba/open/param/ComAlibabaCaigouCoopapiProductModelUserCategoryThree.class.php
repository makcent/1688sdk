...
include_once ('cn/alibaba/open/param/ComAlibabaCaigouCoopapiProductModelUserCategoryFour.class.php');

class ComAlibabaCaigouCoopapiProductModelUserCategoryThree extends SDKDomain {
    ...
    */
    ...
    /**
     * 设置子类目节点     
     * @param array include @see ComAlibabaCaigouCoopapiProductModelUserCategoryFour[] $children     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
    public function setChildren(ComAlibabaCaigouCoopapiProductModelUserCategoryFour $children) {
		...
		$this->stdResult = $stdResult;
    			...
    			$childrenResult=$this->stdResult->{"children"};
					...
					for($i = 0; $i < count ( $object ); $i ++) {
						...
						$ComAlibabaCaigouCoopapiProductModelUserCategoryFourResult=new ComAlibabaCaigouCoopapiProductModelUserCategoryFour();
						$ComAlibabaCaigouCoopapiProductModelUserCategoryFourResult->setArrayResult($arrayobject );
						$this->children [$i] = $ComAlibabaCaigouCoopapiProductModelUserCategoryFourResult;
					}
    			}
    			    		    		}
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$childrenResult=$arrayResult['children'];
    			$this->children = new ComAlibabaCaigouCoopapiProductModelUserCategoryFour();

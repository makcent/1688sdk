...
class AlibabaMarketingShortlinkQueryResultModel extends SDKDomain {
    ...
    */
    ...
    /**
     * 设置返回结果     
     * @param array include @see AlibabaMarketingShortlinkMarketingShortUrlModel[] $result     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
		...
		$this->stdResult = $stdResult;
    			...
    			$resultResult=$this->stdResult->{"result"};
					...
					for($i = 0; $i < count ( $object ); $i ++) {
						...
						$AlibabaMarketingShortlinkMarketingShortUrlModelResult=new AlibabaMarketingShortlinkMarketingShortUrlModel();
						$AlibabaMarketingShortlinkMarketingShortUrlModelResult->setArrayResult($arrayobject );
						$this->result [$i] = $AlibabaMarketingShortlinkMarketingShortUrlModelResult;
					}
    			}
    			    		    		}

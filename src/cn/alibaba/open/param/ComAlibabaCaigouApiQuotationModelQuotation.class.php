...
include_once ('cn/alibaba/open/param/ComAlibabaCaigouApiCommonModelSupplyNoteItem.class.php');
include_once ('cn/alibaba/open/param/ComAlibabaCaigouApiCommonModelPayRequirement.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->buyOfferId = $arrayResult['buyOfferId'];
    			}
    		...
    		$contactInfoResult=$arrayResult['contactInfo'];
    			...
    			$this->totalPrice = $arrayResult['totalPrice'];
    			}
    		    	    			    		    			if (array_key_exists ( "specifications", $this->arrayResult )) {
    			$this->specifications = $arrayResult['specifications'];
    			}
    		    	    			    		    		if (array_key_exists ( "supplyNoteItems", $this->arrayResult )) {
    		$supplyNoteItemsResult=$arrayResult['supplyNoteItems'];
    		...
    		$payRequirementInfoResult=$arrayResult['payRequirementInfo'];
    			    			$this->payRequirementInfo = new ComAlibabaCaigouApiCommonModelPayRequirement();
    			    			$this->payRequirementInfo->setStdResult ( $payRequirementInfoResult);
    		}

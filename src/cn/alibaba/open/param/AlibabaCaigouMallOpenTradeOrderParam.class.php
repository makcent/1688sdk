...
include_once ('cn/alibaba/open/param/AlibabaCaigouMallOpenOfferParam.class.php');
include_once ('cn/alibaba/open/param/AlibabaCaigouMallOpenInvoiceParam.class.php');
include_once ('cn/alibaba/open/param/AlibabaCaigouMallOpenReceiveAddressParam.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$offerListResult=$arrayResult['offerList'];

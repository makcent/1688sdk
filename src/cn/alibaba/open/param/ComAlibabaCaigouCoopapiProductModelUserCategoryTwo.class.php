...
include_once ('cn/alibaba/open/param/ComAlibabaCaigouCoopapiProductModelUserCategoryThree.class.php');

class ComAlibabaCaigouCoopapiProductModelUserCategoryTwo extends SDKDomain {
    ...
    */
    ...
    /**
     * 设置子类目节点     
     * @param array include @see ComAlibabaCaigouCoopapiProductModelUserCategoryThree[] $children     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
    public function setChildren(ComAlibabaCaigouCoopapiProductModelUserCategoryThree $children) {
		...
		$this->stdResult = $stdResult;
    			...
    			$childrenResult=$this->stdResult->{"children"};
					...
					for($i = 0; $i < count ( $object ); $i ++) {
						...
						$ComAlibabaCaigouCoopapiProductModelUserCategoryThreeResult=new ComAlibabaCaigouCoopapiProductModelUserCategoryThree();
						$ComAlibabaCaigouCoopapiProductModelUserCategoryThreeResult->setArrayResult($arrayobject );
						$this->children [$i] = $ComAlibabaCaigouCoopapiProductModelUserCategoryThreeResult;
					}
    			}
    			    		    		}
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$childrenResult=$arrayResult['children'];
    			$this->children = new ComAlibabaCaigouCoopapiProductModelUserCategoryThree();

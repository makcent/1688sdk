...
include_once ('cn/alibaba/open/param/AlibabaCaigouMallOpenInvoiceHeadParam.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$invoiceHeadResult=$arrayResult['invoiceHead'];
    			    			$this->invoiceHead = new AlibabaCaigouMallOpenInvoiceHeadParam();
    			    			$this->invoiceHead->setStdResult ( $invoiceHeadResult);
    		}
    		...
    		$receiveAddressResult=$arrayResult['receiveAddress'];
    			...
    			$this->invoiceHeadUseExists = $arrayResult['invoiceHeadUseExists'];
    			}
    		    	    		}

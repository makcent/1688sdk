...
include_once ('cn/alibaba/open/param/AlibabaRelationConsignerModel.class.php');

class AlibabaRelationConsignersresult extends SDKDomain {
    ...
    */
    ...
    /**
     * 设置结果集合     
     * @param array include @see AlibabaRelationConsignerModel[] $relationModels     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
    public function setRelationModels(AlibabaRelationConsignerModel $relationModels) {
		...
		$this->stdResult = $stdResult;
    			...
    			$relationModelsResult=$this->stdResult->{"relationModels"};
					...
					for($i = 0; $i < count ( $object ); $i ++) {
						...
						$AlibabaRelationConsignerModelResult=new AlibabaRelationConsignerModel();
						$AlibabaRelationConsignerModelResult->setArrayResult($arrayobject );
						$this->relationModels [$i] = $AlibabaRelationConsignerModelResult;
					}
    			}
    			    		    		}
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$relationModelsResult=$arrayResult['relationModels'];
    			$this->relationModels = new AlibabaRelationConsignerModel();

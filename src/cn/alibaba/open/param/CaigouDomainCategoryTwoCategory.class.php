...
include_once ('cn/alibaba/open/param/CaigouDomainCategoryLeafCategory.class.php');

class CaigouDomainCategoryTwoCategory extends SDKDomain {
    ...
    */
    ...
    /**
     * 设置叶子类目列表     
     * @param array include @see CaigouDomainCategoryLeafCategory[] $children     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
    public function setChildren(CaigouDomainCategoryLeafCategory $children) {
		...
		$this->stdResult = $stdResult;
    			...
    			$childrenResult=$this->stdResult->{"children"};
					...
					for($i = 0; $i < count ( $object ); $i ++) {
						...
						$CaigouDomainCategoryLeafCategoryResult=new CaigouDomainCategoryLeafCategory();
						$CaigouDomainCategoryLeafCategoryResult->setArrayResult($arrayobject );
						$this->children [$i] = $CaigouDomainCategoryLeafCategoryResult;
					}
    			}
    			    		    		}
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$childrenResult=$arrayResult['children'];
    			$this->children = new CaigouDomainCategoryLeafCategory();

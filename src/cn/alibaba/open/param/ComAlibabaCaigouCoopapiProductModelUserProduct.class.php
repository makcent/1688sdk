...
class ComAlibabaCaigouCoopapiProductModelUserProduct extends SDKDomain {
    ...
    */
    ...
    private $myCspuId;
        ...
        /**
    * @return 1688系统中myCspu的Id
    */
        public function getMyCspuId() {
        return $this->myCspuId;
    }
     ...
     * 参数示例：<pre>10001</pre>     
     * 此参数必填     */
    public function setMyCspuId( $myCspuId) {
        $this->myCspuId = $myCspuId;
    }
    ...
    */
    ...
    /**
     * 设置附件地址列表     
     * @param array include @see String[] $attachmentList     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
    ...
    */
    ...
    /**
     * 设置图片下载地址列表     
     * @param array include @see String[] $picUrlList     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
...
1688 : 1688 手工导入     
    ...
    */
    ...
    /**
     * 设置类目名称     
     * @param String $userCategoryName     
     * 参数示例：<pre>鞋</pre>     
     * 此参数必填     */
    public function setUserCategoryName( $userCategoryName) {
	...
	public function setStdResult($stdResult) {
		$this->stdResult = $stdResult;
    				...
    				$this->productCode = $this->stdResult->{"productCode"};
    			    		    				    			    			...
    			    		    				    			    			if (array_key_exists ( "myCspuId", $this->stdResult )) {
    				$this->myCspuId = $this->stdResult->{"myCspuId"};
    			}
    				...
    				$this->picUrlList = $this->stdResult->{"picUrlList"};
    			    		    				    			    			...
    			    		    				    			    			if (array_key_exists ( "importType", $this->stdResult )) {
    				$this->importType = $this->stdResult->{"importType"};
    			}
    			    		    				    			    			if (array_key_exists ( "userCategoryName", $this->stdResult )) {
    				$this->userCategoryName = $this->stdResult->{"userCategoryName"};
    			}
    			    		    		}
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->productCode = $arrayResult['productCode'];
    		    	    			    		    			...
    		    	    			    		    			if (array_key_exists ( "myCspuId", $this->arrayResult )) {
    			$this->myCspuId = $arrayResult['myCspuId'];
    			}
    			...
    			$this->picUrlList = $arrayResult['picUrlList'];
    		    	    			    		    			...
    		    	    			    		    			if (array_key_exists ( "importType", $this->arrayResult )) {
    			$this->importType = $arrayResult['importType'];
    			}
    		    	    			    		    			if (array_key_exists ( "userCategoryName", $this->arrayResult )) {
    			$this->userCategoryName = $arrayResult['userCategoryName'];
    			}
    		    	    		}

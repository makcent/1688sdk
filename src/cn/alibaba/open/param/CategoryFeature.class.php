...
include_once ('cn/alibaba/open/param/CategoryFeatureIdValue.class.php');
...
enum 列表类型</pre>     
    ...
    */
    ...
    private $childrenFids;
    
        /**
    * @return 子属性id列表
    */
        public function getChildrenFids() {
        return $this->childrenFids;
    }
    
    /**
     * 设置子属性id列表     
     * @param List $childrenFids     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
    public function setChildrenFids(array $childrenFids) {
    ...
    */
	...
	public function setStdResult($stdResult) {
		$this->stdResult = $stdResult;
    				...
    				$this->outputType = $this->stdResult->{"outputType"};
    			    		    				    			    			...
    			    		    				    			    			if (array_key_exists ( "childrenFids", $this->stdResult )) {
    				$this->childrenFids = $this->stdResult->{"childrenFids"};
    			}
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->fieldType = $arrayResult['fieldType'];
    			}
    		    	    			    		    			if (array_key_exists ( "order", $this->arrayResult )) {
    			$this->order = $arrayResult['order'];
    			}
    			...
    			$this->standardType = $arrayResult['standardType'];
    			}
    		    	    			    		    			if (array_key_exists ( "standardUnit", $this->arrayResult )) {
    			$this->standardUnit = $arrayResult['standardUnit'];
    			}
    		    	    			    		    			if (array_key_exists ( "outputType", $this->arrayResult )) {
    			$this->outputType = $arrayResult['outputType'];
    			}
    		    	    			    		    			if (array_key_exists ( "childrenFids", $this->arrayResult )) {
    			$this->childrenFids = $arrayResult['childrenFids'];
    			}
    		    	    			    		    		if (array_key_exists ( "featureIdValues", $this->arrayResult )) {
    		$featureIdValuesResult=$arrayResult['featureIdValues'];
